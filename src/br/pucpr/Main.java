...
public class Main {
	...
	public static void main(String[] args) {
		...
		ImageIcon img1 = new ImageIcon("../Checkers/src/br/pucpr/img/white.png");
		ImageIcon img2 = new ImageIcon("../Checkers/src/br/pucpr/img/black.png");
	...
	public int movimenta(int xOr, int yOr, int xDest, int yDest) throws MovErr {
